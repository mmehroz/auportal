...
<div class="page-wrapper">
    <div class="content container-fluid">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item active">Bio Attendance Report</li>
					</ul>
				</div>
			</div>
		</div>
		<div>   <p class="alert alert-info" >Select Year Month For Bio Matric Attendance Report</p> </div>
		...
		<div class="panel-body">
	        <div class="row">
	            <div class="col-lg-12">
					<form action="{{ URL::to('/submitselectmonthforattendance')}}"  method="post">
						{{csrf_field()}}
						<div class="row">
							<div class="col-md-5">
