			...
			<div class="row">
				<div class="col-sm-12">
					<ul class="nav nav-tabs nav-tabs-bottom">
						...
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#callforinterview_list">Call For Interview</a>
						</li>
						<!-- <li class="nav-item">
		...
		<div class="tab-content">
			...
			<div class="row" id="modals">
				<div class="col-sm-12 col-md-12">
					<form id="frmeditstore" action="{{ URL::to('/searchintcan')}}" >
...
function getedit($value){
		...
		$('document').ready(function(){
			...
			$('#modals').on('submit','#frmeditstore',function(e){
				...
				$.get('{{ URL::to("/searchintcan")}}/'+vampa+'~'+dampa,function(data){
			...
			function showdata(){
				...
				$.get('{{ URL::to("/callforinterview_listdata")}}',function(data){
