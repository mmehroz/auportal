...
button.btn.mybtn {
	background-image: linear-gradient(to right bottom, #000000, #0f1431) !important;
    COLOR: #FFF;
    font-family: 'Raleway', sans-serif;
    font-size: 16px;
    font-weight: bold;
...
<body>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-3 col-12">
						<a href="#" class="logo">
							<img src="{!! asset('public/img/aulogo.png') !!}">
						</a>
					</div>
    ...
    $('#changeyear').text(val);
		...
		-->
		<footer class="text-center mt-3" style="background-image: linear-gradient(to right bottom, #000000, #0f1431) !important">
