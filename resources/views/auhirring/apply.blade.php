...
<body>
	<div class="w-screen h-screen overflow-y-scroll">
		<div class="w-full h-full flex">
			<div
				class="h-full w-1/2  hidden land:flex flex-col items-start p-10 justify-between" style="background-image: linear-gradient(to right bottom, #000000, #0f1431);">
				<a href="/">
				<img src="{!! asset('public/img/aulogo.png') !!}" style="width:100%;">
				</a>
...
<div class="col-lg-12">
	...
	src="{!! asset('public/img/Asset 3@4x 1.png') !!}"
				...
				<div class="w-full flex">
					<p class="text-white">© Copyright 2023 AU Telecom. All rights reserved</p>
				</div>
			</div>
			<div
				class="w-full land:w-1/2 flex flex-col items-start px-10 py-10 pb-40 sm:pb-40 justify-between overflow-y-scroll">
				<div>
					<h2 class="text-[26px] font-bold text-primaryText font-primary mt-10" >Welcome to AU Telecom!</h2>
...
At <b>AU Telecom</b>, we are committed to creating a supportive and inclusive work environment where everyone can thrive. We believe that our employees are our most valuable asset and we are always looking for talented individuals who share our values and vision.<br><br>
...
Thank you for considering <b>AU Telecom</b> as your potential employer. We look forward to reviewing your application and getting to know you better.</h2>
</div>


				
				<div class=" sm:w-[50%] 2xl:w-[40%] flex mt-10 justify-between items-center">				<a style="text-decoration:none;" href="{{URL('aujobform')}}/{{$data}}"><button
							...
							style="color: white; transform: none;    background-image: linear-gradient(to right bottom, #000000, #0f1431);" type="submit" ><span>Apply Now</span></button></a>
