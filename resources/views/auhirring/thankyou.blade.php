...
<br><br>We want to thank you for taking the time to submit your job application to <b>AU Telecom</b>. We appreciate your interest in our organization and the effort you put into completing the application process.
...
<br><br>We encourage you to remain patient and positive during this waiting period. We will be in touch with you as soon as possible to inform you of the next steps in the hiring process. In the meantime, please feel free to explore our website to learn more about <b>AU Telecom</b> and the work that we do. Here is your application step and it's future journey. 

<br><br>Again, thank you for considering <b>AU Telecom</b> as your potential employer. We appreciate your interest in our organization and look forward to getting to know you better as we move forward in the hiring process.
...
AU Telecom</b>
				...
				<div class=" sm:w-[50%] 2xl:w-[40%] flex mt-10 justify-between items-center">				<a style="text-decoration:none;" href="https://arcinventador.com/"><button
							...
							style="color: white; transform: none;    background-image: linear-gradient(to right bottom, #000000, #0f1431);" type="submit" ><span>Finish</span></button></a>
