									...
									<table class="table table-striped custom-table datatable" id="attrep">
										...
										<tbody>
											...
											<tr>
												...
												<?php
											if($i < 10) {
												$attendancestatus = DB::connection('mysql')->table('attendancetimeout')
												->where('attendancetimeout.elsemployees_empid','=',$val->elsemployees_batchid)
												->where('attendancetimeout.attendance_month','=',$data['sendmonth'])
												->where('attendancetimeout.attendance_date','LIKE',$data['sendyear'].'-'.'%'.'-'."0$daydate")
												...
												->where('attendancetimeout.elsemployees_empid','=',$val->elsemployees_batchid)
												->where('attendancetimeout.attendance_month','=',$data['sendmonth'])
												->where('attendancetimeout.attendance_date','LIKE',$data['sendyear'].'-'.'%'.'-'."$daydate")
												->select('attendancetimeout.*')
												->first();
											}
