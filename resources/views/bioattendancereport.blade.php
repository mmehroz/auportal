								...
								<div class="table-responsive">
									<table class="table table-striped custom-table datatable table-fixed" id="payrolldata">
										<thead>
											...
											<th>Employee Share BF</th>
											<th>Company Share BF</th>
											<th>Total BF/Month</th>
											<th>Net BF</th>
											...
											<tr>
											  ...
											  while( $x < $count_length ) {
											   ...
											   " . $change_words[$amount_after_decimal % 10]) . ' Paise' : '';
												...
												<td style="background-color: #f8cbad">PKR <?php echo(number_format($fund))?></td>
												<td style="background-color: #f8cbad">PKR <?php echo(number_format($bfaccumulated))?></td>
												...
												<td style="background-color: #f8cbad">PKR <?php echo(number_format(round($attendancededuction)))?></td>
												...
												<td style="background-color: #d9e1f2">PKR <?php echo(number_format(round($correction)))?></td>
