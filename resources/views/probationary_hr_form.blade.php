    ...
    <body>	
        ...
        <div class="main-wrapper">		
            ...
            <div class="content container-fluid">
				...
				<form action="{{ URL::to('/submitprobationaeryhrform')}}" method="POST" class="form-horizontal"enctype="multipart/form-data">
					@csrf
					<div class="page-menu">
						<div class="row">
							<div class="col-md-12">							
								<ul class="nav nav-tabs nav-tabs-bottom">
									<li class="nav-item col-md-3">
										<a class="nav-link navtest active" data-toggle="tab" id="hractive" href="#HRM"><center>Human Resource Department</center></a>
									</li>
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<select class="form-control selectpicker form-control" placeholder="" data-live-search ="true"  name="empstatus">
													<option value="" selected="" disabled="" >Select the Following</option>
