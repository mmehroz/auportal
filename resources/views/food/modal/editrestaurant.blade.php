...
<div id="editrestaurant" class="modal custom-modal fade" role="dialog">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<form action="{{ URL::to('/submiteditretaurant')}}" id="editsubmitannou" method="POST"  enctype="multipart/form-data">
			{{ csrf_field() }} 
			<input type="hidden"  name="hdnrestaurantid" value="{{$data->restaurant_id}}" class="form-control">
					<div class="form-group">
						<label>Name<span class="text-danger"></span></label>
						<input class="form-control" name="name" value="{{$data->restaurant_name}}" required type="text">
					</div>
					<div class="form-group">
					<label>Other Details<span class="text-danger"></span></label>
                        <textarea class="form-control" id="details" name="details" value="" rows="5">{{$data->restaurant_otherdetails}}</textarea>
                    </div>
                     <div class="form-group">
