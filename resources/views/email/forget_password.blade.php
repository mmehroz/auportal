							        ...
							        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
							          ...
							          <tr>
							            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
							              <p style="margin: 0; color: #000;">You recently requested to reset your password for <b>HRMS BWC</b>. Click the button below to reset it.</p>
							            </td>
							          </tr>
							          <!-- end copy -->
							          <!-- start button -->
							                    ...
							                    <table border="0" cellpadding="0" cellspacing="0">
							                      <tr>
							                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
							                          <a href="{{url('forget')}}/{{$verify_token}}" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; background-color: #85152d;text-decoration: none; border-radius: 6px;">Reset Your Password</a>
							                        </td>
							                      </tr>
							                    </table>
							                  </td>
							          ...
							          <tr>
							            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
							              <p style="margin: 0;  color: #000;">If you're having trouble clicking the password reset button, copy and paste the URL, below into your browser.</p>
