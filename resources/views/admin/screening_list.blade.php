			...
			<div class="row">
				<div class="col-sm-12">
					<ul class="nav nav-tabs nav-tabs-bottom">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#screening_list">Screening List</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="tab-content">
			...
			<!-- <div class="row" id="modals">
				<div class="col-sm-12 col-md-12">
					<form id="frmeditstore" action="{{ URL::to('/searchscr')}}" >
						<div class="row filter-row" style="display: flex!important;">
							<div class="col-sm-6 col-md-4">  
								...
								<select class="select floating select2-hidden-accessible" name="mydata" id="searchdrop">
									...
									<option value="department">Postion Appplied for</option>
								</select>
							</div>
...
$('document').ready(function(){
		...
		$('#modals').on('submit','#frmeditstore',function(e){
			...
			$.get('{{ URL::to("/searchscr")}}/'+vampa+'~'+dampa,function(data){
		...
		function showdata(){
			...
			$.get('{{ URL::to("/screening_listdata")}}',function(data){
