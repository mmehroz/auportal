									...
									<tr style="text-align: center;">
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												<a style="color: #5069e7" href="{{ URL::to('/modalademployeeviewol/')}}/{{$datas->jobapplicant_id}}" target="_blank" ><i class="fa fa-ellipsis-v"></i></a>
										...
										<td>
											<div class="dropdown dropdown-action">
											<a href="#" style="color: #5069e7" class="fa fa-ellipsis-v dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
												<div class="dropdown-menu dropdown-menu-right">
