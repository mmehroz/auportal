...
<div class="page-wrapper">
    <div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row">
				<div class="col-sm-12">
					<h3 class="page-title">Bio Matric</h3>
					<ul class="breadcrumb">
		...
		<div class="panel-body">
	        <div class="row">
	            <div class="col-lg-12">
					<form action="{{ URL::to('/monthlylistattendance')}}"  method="post">
						{{csrf_field()}}
						<div class="row">
							<div class="col-md-5">
					 ...
					 <!--    	<div class="col-md-5">
						        <label for="attmonth">Select Depart</label>
						        <select class="form-control"  name="attendancedepart"  required>	
                            		<option selected="" disabled="" value="{{ old('attendancedepart') }}">Select Employee Department</option>
                       				@foreach($employee as $employees)
                            		<option value={{$employees->elsemployees_batchid}}>{{$employees->elsemployees_name}}</option>
                        			@endforeach 
                                </select>
					    	</div> -->
