...
<div id="getimage" class="modal custom-modal fade" role="dialog">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Load Your Image</h5>
			...
			<form action="{{URL::to('/loadimage')}}" id="frmimage" method="post" enctype="multipart/form-data">
				{{ csrf_field() }}
				<ul id="errors" class="list-unstyled" >
                </ul>
				<input type="hidden" name="editreqid" value="{{session()->get('id')}}" />
				<div class="form-group">
					<label for="activeStatus">Your Image</label>
				...
				<div class="form-group text-center">
					<button class="btn btn-primary account-btn" type="submit">Load Image</button>
				</div>
			</form>
			</div>
		</div>
