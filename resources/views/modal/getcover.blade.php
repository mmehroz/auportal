...
<div id="getcover" class="modal custom-modal fade" role="dialog">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<form action="{{URL::to('/loadcover')}}" id="frmimage" method="post" enctype="multipart/form-data">
				{{ csrf_field() }}
				<ul id="errors" class="list-unstyled" >
                </ul>
				<input type="hidden" name="editreqid" value="{{session()->get('id')}}" />
				<div class="form-group">
					<label for="activeStatus">Cover Image</label>
