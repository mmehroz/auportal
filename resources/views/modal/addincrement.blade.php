...
<div id="addincrement" class="modal custom-modal fade" role="dialog">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<form action="{{ URL::to('/addincrement')}}" id="frmAddSalaries" method="POST"  enctype="multipart/form-data">
			{{ csrf_field() }} 
					...
					<div class="submit-section">
						<button id="submit" class="btn btn-primary submit-btn">Add Increment</button>
					</div>
				</form>
			</div>
		</div>
