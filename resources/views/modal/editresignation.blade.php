...
<div id="editresignation" class="modal custom-modal fade" role="dialog">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<form action="{{ URL::to('/editsubmitresignation')}}" id="editsubmitresig" method="POST"  enctype="multipart/form-data">
			{{ csrf_field() }} 
			<input type="hidden"  name="hdnresigid" value="{{$data->resignation_id}}" class="form-control">
					...
					<div class="form-group">
						...
						<div class="cal-icon">
							<input class="form-control datetimepicker" id="datetimepicker" name=lastdate value="{{$data->resig_lastdate}}" type="text">
						</div>
					</div>
					<div class="form-group">
						<label>Submit Date<span class="text-danger"></span></label>
						<div class="cal-icon">
							<input class="form-control datetimepicker" id="datetimepicker1" name=submitdate value="{{$data->resig_submitdate}}" type="text">
						</div>
					</div>
					<div class="form-group">
