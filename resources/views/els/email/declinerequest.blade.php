							        ...
							        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
							          <tr>
							            <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
							              <h1 style="text-align: center; font-size: 45px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">Declined</h1>
							            </td>
							          </tr>
							        </table>
							      </td>
							    ...
							    <tr>
							      <td align="center" bgcolor="#e9ecef">
							        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
							          <!-- start copy -->
							          <tr><td align="center">
												<div style="line-height: 24px; background-color: #fff;">
													...
													<span style="font-family: Arial, Helvetica, sans-serif;font-size: 17px;color: rgba(0, 0, 0, 0.99);font-variant: small-caps;">
														{{ $datas->elsemployees_name }} request for @if($datas->elsleaverequests_leavetypeid == 1) Annual @elseif ($datas->elsleaverequests_leavetypeid == 2) Sick @else Unpaid @endif , Date : <b style="color: red;">{{$datas->elsleaverequests_leavestartdate}} to {{$datas->elsleaverequests_leaveenddate}}</b> has been declined, for more detail kindly visit the below link.
													</span>
													</font>
												</div>
