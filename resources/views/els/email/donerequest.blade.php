...
<head>
						...
						<div class="account-wrapper">
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
							    ...
							    <!-- end hero -->
							    						   ...
							    						   <!--content 1 -->
	<tr><td align="center" bgcolor="#e9ecef">
		<table border="0" cellpadding="0" cellspacing="0"  bgcolor="#fff" width="100%" style="max-width: 600px; padding-right: 10px; padding-left: 10px;">
			<!-- <tr><td align="center">
			...
			<tr><td align="center">
				<div style="line-height: 24px;">
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #000000;">
						<b style="font-variant: small-caps;color: #f44336;">{{ $datas['data']->elsemployees_name }}</b> request for @if($datas['data']->elsleaverequests_leavetypeid == 1) Annual @elseif ($datas['data']->elsleaverequests_leavetypeid == 2) Sick @else Unpaid @endif Leave Date : <b style="color: red;">{{$datas['data']->elsleaverequests_leavestartdate}} to {{$datas['data']->elsleaverequests_leaveenddate}}</b> request has been done, Details are shown below.
					</span></font>
				</div>
	...
	<!--content 1 END-->
	<!--content 2 -->
	<tr><td align="center" bgcolor="#e9ecef" style="border-bottom-width: 0px; border-bottom-style: solid; border-bottom-color: #eff2f4;">
		<table width="94%" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px;"  bgcolor="#fff">
			<tr><td align="center">
						...
						<tr><td align="center" style="line-height: 14px; padding: 0 27px;">
							...
							<div style="line-height: 14px;">
								...
								<strong style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #85152d;">
									<a href="#"style="color: #85152d; text-decoration: none;font-variant: small-caps; font-size:16px;">Approved By</a>
								</strong></font>
							</div>
					...
					<table class="mob_100" width="100%" border="0" cellspacing="0" cellpadding="0" align="left" style="border-collapse: collapse;">
						<tr><td align="center" style="line-height: 14px; padding: 0 27px;">
							...
							<div style="line-height: 14px;">
								...
								<strong style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #85152d;">
									<a href="#" style="color: #85152d; text-decoration: none; font-variant: small-caps; font-size:16px;">Done By</a>
								</strong></font>
							</div>
							<!-- padding --><div style="height: 10px; line-height: 18px; font-size: 10px;"> </div>
							<div style="line-height: 21px;">
	        ...
	        <tr>
	            <td align="center" bgcolor="#e9ecef">
	              <table border="0" cellpadding="0" cellspacing="0" style="max-width: 600px;" width="100%">
	                <tr>
	                  <td align="center" bgcolor="#fff" style="padding: 12px;padding-bottom: 30px;">
