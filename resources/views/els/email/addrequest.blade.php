							        ...
							        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
							          <tr>
							            <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
							              <h1 style="text-align: center; font-size: 45px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">PENDING</h1>
							            </td>
							          </tr>
							        </table>
							      </td>
							        ...
							        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
							          ...
							          <tr>
							            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
							              <p style="margin: 0; color: #000;">{{$datas->name}} request for @if($datas->leaveType == 1) Annual @elseif ($datas->leaveType == 2) Sick @else Unpaid @endif, Date : <b style="color: red;">{{$datas->startDate}} to {{$datas->endDate}}</b> has been added, for more detail kindly visit the below link.</p>
							            </td>
							          </tr>
							          <!-- end copy -->
							          <!-- start button -->
