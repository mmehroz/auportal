			...
			<div class="row align-items-center">
				<div class="col">
					...
					<!-- <div class="col-auto float-right ml-auto">
						...
						<a href="{{url('/approvedmulti_request')}}" class="btn add-btn"><i class="fa fa-check"></i> Approved Multiple Request</a>
						@endif
					</div> -->
				</div>
			</div>
									...
									<tbody>
										...
										?>
											...
											<!--<td>{{$val->elsleaverequests_reamainingsickleave}}</td>
												...
												<td >@if ( $val->elsleaverequests_status == "Approved" AND session()->get("role") <= 2   )
													<span>
													...
													&nbsp;<span>
														<i style="cursor: pointer;" onclick="approve({{'"'.$val->elsleaverequests_id.'"'}})" title="Approve With Comment" class="fa fa-check text-success"></i>
													&nbsp;</span>
													&nbsp;&nbsp;<span>
														<i style="cursor: pointer;" onclick="decline({{'"'.$val->elsleaverequests_id.'"'}})" title="Decline Request"  class="fa fa-close"></i>&nbsp;
													</span>&nbsp;
													...
													@if(session()->get("email") == "salman.khairi@bizzworld.com")
														@if( $val->elsleaverequests_status == "Pending" AND session()->get("role") <= 3 )
														&nbsp;
														<span>
