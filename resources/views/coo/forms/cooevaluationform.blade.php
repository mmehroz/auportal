								...
								<form class="user" action="{{ URL::to('/submithrevucancooform')}}" id="" enctype="multipart/form-data" method="post">
									...
									<div class="table-responsive">
							            <table class="table table-bordered">
							                ...
							                <tbody>
							                	<td>Personal</td>
							                	<td><select class="select" name="can_hr_pre"  readonly >
							                	...
							                	<td><select class="select" name="can_hr_verbal_ski"  readonly >
							                	...
							                	<td><select class="select" name="can_hr_body"  readonly >
							                	...
							                	<td><select class="select" name="can_hr_manner"  readonly >
							                	...
							                	<td><select class="select" name="can_hr_rea"  readonly >
									...
									<div class="table-responsive">
							            <table class="table table-bordered">
							                ...
							                <tbody>
							                	<td>Personal</td>
							                	<td><select class="select" name="can_hod_job_rel"  readonly >
							                	...
							                	<td><select class="select" name="can_hod_exp"  readonly >
							                	...
							                	<td><select class="select" name="can_hod_know"  readonly >
							                	...
							                	<td><select class="select" name="can_hod_carpro"  readonly >
							                	...
							                	<td><select class="select" name="can_hod_noble"  readonly >
							                	...
							                	<td><select class="select" name="can_hod_pot"  readonly >
									...
									<div class="row">
							            ...
							            <div class="col-md-3">
											<div class="form-group">
												...
												<select class="select" name="can_approval"  required >
