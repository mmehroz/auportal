...
<head>
	...
	<title>INTERVIEW ASSESSMENT & RECOMMENDATION FORM</title>
	...
	<div class="main-wrapper">
		...
		<div class="mainheader">
            ...
            <div class="content container-fluid">
				...
				<form class="user" action="{{ URL::to('/submithrevucancooform')}}" id="" enctype="multipart/form-data" method="post">
					{{csrf_field()}}
					<div class="card flex-fill">
					<div class="card-header">
						<h4 class="card-title mb-0 text-center">Candidate Personal Data</h4>
					</div>
					<div class="card-body">
									...
									<div class="row">
									    ...
									    <div class="col-md-4">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="can_ref" value="{{old('can_ref', @$data->can_evu_reference ) }}" readonly  />
											</div>
										</div>
									...
									<div class="row">
									    ...
									    <div class="col-md-4">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="can_exp_benefit" value="{{old('can_exp_benefit', @$data->can_evu_expbnft ) }}" readonly />
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
					...
					<div class="card flex-fill">
								...
								<p style="color:#f90202;">Filled by HR Department</p>
									...
									<div class="table-responsive">
							            <table class="table table-bordered">
							                ...
							                <tbody>
							                	<td>Personal</td>
							                	<td><select class="select form-control" name="can_hr_pre"  readonly >
							                	...
							                	<td><select class="select form-control" name="can_hr_verbal_ski"  readonly >
							                	...
							                	<td><select class="select form-control" name="can_hr_body"  readonly >
							                	...
							                	<td><select class="select form-control" name="can_hr_manner"  readonly >
							                	...
							                	<td><select class="select form-control" name="can_hr_rea"  readonly >
									...
									<div class="row">
									    <div class="col-md-4">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="can_hr_intname" value="{{old('can_hr_intname', @$data->can_evu_hr_int_name ) }}" readonly />
											</div>
										</div>
									    <div class="col-md-4">
											<div class="form-group">
						...
						<div class="card flex-fill">
							<div class="card-header">
								<h4 class="card-title mb-0">Departmental Head Assessment</h4>
							</div>
							<div class="card-body">
								...
								<div class="table-responsive">
									<table class="table table-bordered">
										...
										<tbody>
											<td>Personal</td>
											<td><select class="select form-control" name="can_hod_job_rel"  readonly >
											...
											<td><select class="select form-control" name="can_hod_exp"  readonly >
											...
											<td><select class="select form-control" name="can_hod_know"  readonly >
											...
											<td><select class="select form-control" name="can_hod_carpro"  readonly >
											...
											<td><select class="select form-control" name="can_hod_noble"  readonly >
											...
											<td><select class="select form-control" name="can_hod_pot"  readonly >
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea rows="2" cols="5" class="form-control" placeholder="Enter Your Comment"  readonly >{{old('can_hod_commets', @$data->can_evu_hod_comments ) }}</textarea>
										</div>
									</div>
								</div>
						...
						<div class="card flex-fill">
							<div class="card-header">
								<h4 class="card-title mb-0">Approval Authority</h4>
							</div>
							<div class="card-body">
								<div class="row">
									<div class="col-md-4">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label class="col-form-label">HR Offered Salary</label>
											<input type="number" min="0" class="form-control"  value="{{old('can_rec_sal', @$data->can_evu_off_salary ) }}" readonly />
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label class="col-form-label">HR Offered Designation</label>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label class="col-form-label">Recommended Salary</label>
											<input type="number" min="0" class="form-control" name="can_rec_sal" value="{{old('can_rec_sal', @$data->can_evu_rec_sal ) }}" required />
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label class="col-form-label">Proposed Designation</label>
											<input type="text" class="form-control" name="can_pro_desg" value="{{old('can_pro_desg', @$data->can_evu_pro_desg ) }}" required />
										</div>
									</div>
									
								</div>
								@if($data->can_evu_sal_afpro)
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label class="col-form-label">Return From HR Salary Proposed after Probition</label>
											<input type="text" class="form-control"  value="{{old('can_pro_desg', @$data->can_evu_sal_afpro ) }}" readonly />
										</div>
									</div>
								</div>
								@endif
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<textarea rows="3" cols="5" class="form-control" placeholder="Enter message" name="can_coo_remark" >{{old('can_coo_remark', @$data->can_evu_coo_remark ) }}</textarea>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label class="col-form-label">Expected Joining Date</label>
											<input type="date" class="form-control"  value="{{old('can_pro_desg', @$data->can_evu_hr_expdate ) }}" readonly />
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label class="col-form-label"  >Approval</label>
											<select class="select form-control" name="can_approval"  required >
									...
									<div class="col-md-4">
										<div class="form-group">
											<label class="col-form-label">Name</label>
											<input type="text" class="form-control" name="can_app_name" value="{{old('can_app_name', @$data->jobapplicant_name ) }}" readonly />
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label class="col-form-label">Date</label>
											<input type="date" class="form-control" name="can_app_date" value="<?php echo date('Y-m-d'); ?>" readonly />
										</div>
									</div>
								</div>
								<div class="row">
