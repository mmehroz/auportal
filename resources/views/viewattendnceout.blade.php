							...
							<div class="table-responsive">
								<table class="table table-striped custom-table table-nowrap mb-0" id="vatt">
									...
									<tbody>
										...
										<tr>
											<td >
												<span>&nbsp;<i onclick="viewempattendanceout({{'"'.$val->elsemployees_batchid.'"'}})" class="fa fa-eye" ></i></span>
											</td>
											...
											?>{{$reportingtoname}}</td>
											<td><?php 
												$present = DB::connection('mysql')->table('attendancetimeout')
...
<script>
   ...
   function viewempattendanceout($id){
		window.location.replace('{{ URL::to("/viewempattendanceout")}}/'+$id);
