...
<head>
    ...
    <link
        ...
        rel="stylesheet" />
    <!--<![endif]-->
    <title>Offer Letter - Arc Inventador</title>
    <!--[if gte mso 9]>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="text-left pb20"
                                                    ...
                                                    <multiline>  We are pleased to inform you that based on your qualifications, experience, and interview performance, Arc Inventador has decided to offer you the position of <strong>{{$datas['candidatedata']->evu_cantechdesgdept}}</strong>.
                                                        <br><br>
