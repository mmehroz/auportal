...
<head>
    ...
    <!--<![endif]-->
	<title>Submit your job application to Arc inventador - HRMS</title>
	<!--[if gte mso 9]>
					...
					<tr>
						<td class="td" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<!-- Logo -->
								<tr>
									<td bgcolor="#ffffff" class="p30-15 img-center" style="padding: 30px; border-radius: 20px 20px 0px 0px; font-size:0pt; line-height:0pt; text-align:left;"><a href="https://www.arcinventador.com/" target="_blank"><img src="https://avidhaus.com/images/arclogo.png" width="146" height="57" border="0" alt="" /></a></td>
								</tr>
								<!-- END Logo -->
								<!-- Nav -->
								...
								<tr>
									<td class="p30-15-0" style="padding: 30px 30px 0px 30px;">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												<td class="text-left pb20"style="color:#5d5c5c; font-family:'Raleway', Arial,sans-serif; font-size:14px; line-height:22px; text-align:left; padding-bottom:20px;"><multiline>We want to thank you for taking the time to submit your job application to Arc inventador. We appreciate your interest in our organization and the effort you put into completing the application process.
                                                    <br>
                                                    <br>
                                                    ...
                                                    <br>
                                                    <br>
                                                    We encourage you to remain patient and positive during this waiting period. We will be in touch with you as soon as possible to inform you of the next steps in the hiring process. In the meantime, please feel free to explore our website to learn more about Arc Inventador and the work that we do. Here is your application step and it's future journey. 
                                                    <br>
                                                    <br>
                                                    Again, thank you for considering Arc Inventador as your potential employer. We appreciate your interest in our organization and look forward to getting to know you better as we move forward in the hiring process.
                                                    <br>
                                                    <br>
                                                    <br>
													...
													Team Recruitment
													<br>
													Arc Inventador</strong></multiline></td>
											</tr>
											<!-- Button -->
