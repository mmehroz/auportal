...
<head>
	...
	<style type="text/css" media="screen">
		/* Linked Styles */
		body { padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; background:#5069e7; -webkit-text-size-adjust:none }
...
<body class="body"style="padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; background:#5069e7; -webkit-text-size-adjust:none;">
    <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
        Interview Invitation | Cyberxify
    </div>
								...
								<tbody><tr>
									<td align="right">
										<table class="center" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
											<tbody><tr>
												<td class="img" width="32" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
												<td class="img" width="32" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
												<td class="img" width="32" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
												<td class="img" width="32" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
												<td class="img" width="14" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
											</tr>
										</tbody></table>
									</td>
								</tr>
					...
					<tr>
						<td class="td" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<!-- Logo -->
								<tr>
								<td bgcolor="#ffffff" class="p30-15 img-center" style="padding: 30px; border-radius: 20px 20px 0px 0px; font-size:0pt; line-height:0pt; text-align:left;"><a href="" target="_blank"><img src="{!! asset('public/img/logogrey.png') !!}" width="146" height="57" border="0" alt="" /></a></td>
								</tr>
								<!-- END Logo -->
								<!-- Nav -->
								...
								<tr>
									<td class="p30-15-0" style="padding: 30px 30px 0px 30px;">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												<td class="h2-center"style="color:#000000; font-family:'Playfair Display', Times, 'Times New Roman', serif; font-size:32px; line-height:36px; text-align:left; padding-bottom:20px;"><multiline>Dear {{$datas['candidatedata']->jobapplicant_name }} {{$datas['candidatedata']->jobapplicant_fname}},</multiline></td>
											</tr>
											<!-- <tr>
												<td class="h4-center"style="color:#000000; font-family:'Playfair Display', Times, 'Times New Roman', serif; font-size:16px; line-height:36px; text-align:left; padding-bottom:20px;font-weight:bold"><multiline>Thank You for Interviewing with Cyberxify</multiline></td>
											</tr> -->
                                             <!-- start copy -->
							          <tr>
									  <td class="text-left pb20"style="color:#5d5c5c; font-family:'Raleway', Arial,sans-serif; font-size:14px; line-height:22px; text-align:left; padding-bottom:20px;">
 ...
 <p style="margin: 0; color: #000;">
							            	...
							            	Don’t miss this opportunity as <b>Cyberxify</b> gives candidates a platform to further discuss their background and expand on key aspects of their work experience that make them a great fit for the position and help find their dream job.<br>
							          		Please share your updated resume and acknowledge when received.</p>
							            </td>
							          </tr>
											<!-- <tr>
												<td class="text-left pb20"style="color:#5d5c5c; font-family:'Raleway', Arial,sans-serif; font-size:14px; line-height:22px; text-align:left; padding-bottom:20px;">
                                                    <multiline>We want to thank you for taking the time to submit your job application to Cyberxify. We appreciate your interest in our organization and the effort you put into completing the application process.
                                                    <br>
                                                    <br>
                                                    We understand that waiting to hear back from potential employers can be challenging, but please know that we have received your application and will review it carefully. Our team of hiring managers will evaluate your qualifications, experience, and suitability for the role to determine if there is a fit for you at our organization.
                                                    <br>
                                                    <br>
                                                    We encourage you to remain patient and positive during this waiting period. We will be in touch with you as soon as possible to inform you of the next steps in the hiring process. In the meantime, please feel free to explore our website to learn more about Cyberxify and the work that we do. Here is your application step and it's future journey. 
                                                    <br>
                                                    <br>
                                                    Again, thank you for considering Cyberxify as your potential employer. We appreciate your interest in our organization and look forward to getting to know you better as we move forward in the hiring process.
                                                    <br>
                                                    <br>
                                                    <br>
															...
															<th class="column-top" width="180"style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="text-footer"style="color:#5d5c5c; font-family:'Raleway', Arial,sans-serif; font-size:13px; line-height:22px; text-align:left;">
																			<multiline>
																				<strong>info@arcinventador.com</strong></multiline>
																		</td>
																	</tr>
																</table>
															</th>
															...
															<th class="column-top" width="180"style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="text-footer"style="color:#5d5c5c; font-family:'Raleway', Arial,sans-serif; font-size:13px; line-height:22px; text-align:left;">
																			<multiline>
																				<strong>www.arcinventador.com</strong></multiline>
																		</td>
																	</tr>
																</table>
															</th>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="text-footer2 p30-15" style="padding: 30px 15px 50px 15px; color:#a9b6e0; font-family:'Raleway', Arial,sans-serif; font-size:12px; line-height:22px; text-align:center;"><multiline style="color: #fff;">3rd floor B&H house, B-75, Gulshan-e-Iqbal, karachi, pakistan , Karachi, Pakistan <br /><p style="color: #fff;">© 2023 Arc-Inventador . All Right Reserved.</p></multiline></td>
								</tr>
							</table>
							<!-- END Footer -->
						</td>
