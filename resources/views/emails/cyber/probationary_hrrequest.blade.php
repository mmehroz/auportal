							        ...
							        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
							          ...
							          <tr>
							            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
							            	<p style="margin: 0; color: #000;">Dear HR,<br>Mr.
						              			<span style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: 700; color: #000000;text-transform:capitalize;">Salman Khairi
						              			</span> has recently proceed the probation form of Mr.<b style="color: #000000;">{{$datas->elsemployees_name}}</b> from <b style="color: #000000;">{{$datas->dept_name}}</b>,  you are requested to further proceed the request.</p>
							            </td>
							          </tr>
							          <!-- end copy -->
							          <!-- start button -->
