				...
				<div class="container">
					<!-- <div class="account-box"> -->
						<div class="account-wrapper">
							...
							Candidate Arrival For Interview | Cyberxify
							</div>
							<!-- end preheader -->
							        ...
							        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
							          ...
							          <tr>
							            <td align="left" bgcolor="#ffffff" style="padding: 24px;  padding-bottom:0px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
							              <p style="margin: 0; color: #000;">We have a Candidate name <b>{{$datas['candidate']->jobapplicant_name }}</b> which you approved to attend an interview is evaluate by admin now the candidate is coming to your department kindly review HRM Recruiting Portal section evaluation to get the evaluation form of the candidate.</p>
							            </td>
							          </tr>
							          <!-- end copy -->
							          <tr>
