...
<body class="body"
    ...
    <div class="preheader"
        ...
        Human Resource Management System | Cyberxify
    </div>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="h2-center"
                                                    ...
                                                    <multiline>Dear {{$datas->elsemployees_name}},<br>Congratulations!
                                                    </multiline>
                                                </td>
                                            </tr>
                                            <!-- <tr>
                                            ...
                                            <tr>
                                                <td class="text-left pb20"
                                                    ...
                                                    <multiline>Based on your continuous performance over the period,  we are pleased to inform you that your employment has been confirmed.
                                                        <br>
                                                        <br>
                                                        <br>
