...
<head>
        ...
        <title>Probationary Form Request</title>
								          	...
								          	<tr>
								            	<td align="center" valign="top" style="padding: 20px 24px;">
								            		<a href="https://autelecom.net/" target="_blank" style="display: inline-block;">
								                		<img src="{!! asset('public/img/logogrey.png') !!}" alt="BWC" border="0" width="48" style="display: block; width: 278px; max-width: 100%; min-width: 48px;">
								            		</a>
								            	</td>
								          	</tr>
							        	</table>
							        ...
							        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
							          <tr>
							            <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
							              <h1 style="text-align: center; font-size: 35px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">PROBATIONARY EMPLOYEE</h1>
							            </td>
							          </tr>
							        </table>
							      </td>
							        ...
							        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
							          ...
							          <tr>
							            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
							            	<p style="margin: 0; color: #000;">Dear COO,<br>Mr.
						              			<span style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: 700; color: #000000;text-transform:capitalize;"><?php
														$reportemail = DB::connection('mysql')->table('elsemployees')
														->where('elsemployees.elsemployees_empid','=',$datas->elsemployees_reportingto)
														->select('elsemployees.*')
														->first();
														?>{{$reportemail->elsemployees_name}}
						              			</span> has recently submit the probation form of Mr.<b style="color: #000000;">{{$datas->elsemployees_name}}</b> from <b style="color: #000000;">{{$datas->dept_name}}</b>,  you are requested to further proceed the request.</p>
							            </td>
							          </tr>
							          <!-- end copy -->
							          <!-- start button -->
							        ...
							        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
							          ...
							          <tr>
							            <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
							              ...
							              <p style="margin: 0;">&copy; <b>Cyberxify</b> 2021. All Right Reserved. </p>
							            </td>
							          </tr>
							          <!-- end unsubscribe -->
							        </table>
