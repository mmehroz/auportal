							        ...
							        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
							          ...
							          <tr>
							            <td align="left" bgcolor="#ffffff" style="padding: 24px;  padding-bottom:0px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
							              <p style="margin: 0; color: #000;">Just a notification We have a Candidate name <b>{{$datas['candidate']->jobapplicant_name }}</b> which has screened by HR to attend an interview is coming for interview soon.<a href="http://209.182.216.71/hrm"><strong>Kindly Click Here To Review the Candidate in Candidatelist</strong> </a></p>
							            </td>
							          </tr>
							          <!-- end copy -->
							          <tr>
