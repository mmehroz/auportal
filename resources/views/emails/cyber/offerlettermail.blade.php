...
<head>
    ...
    <link
        ...
        rel="stylesheet" />
    <!--<![endif]-->
    <title>Offer Letter - Cyberxify</title>
    <!--[if gte mso 9]>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td bgcolor="#ffffff" class="p30-15 img-center"
                                        ...
                                        src="{!! asset('public/img/logogrey.png') !!}" width="146" height="57"
                                                border="0" alt="" /></a></td>
                                </tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="text-left pb20"
                                                    ...
                                                    <multiline>  We are pleased to inform you that based on your qualifications, experience, and interview performance, Cyberxify has decided to offer you the position of <strong>{{$datas['candidatedata']->evu_cantechdesgdept}}</strong>.
                                                        <br><br>
                                                        <!-- <p>{{$datas['candidatedata']->evu_cansalary}}</p><br><br> -->
                                                        We believe that your skills and experience align with our organization's requirements, and we are confident that you will be a valuable addition to our team. Enclosed, you will find your appointment letter that outlines the terms and conditions of your employment with Cyberxify.
                                                        <br><br>
                                                        ...
                                                        <br><br>
                                                        Congratulations once again, and we wish you all the best for a successful career at Cyberxify.
                                                        <br><br>
