                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="h2-center"
                                                    ...
                                                    <multiline>Dear {{$empdata->emp_name}}</multiline>
                                                </td>
                                            </tr>
                                            <!-- <tr>
                                            ...
                                            <tr>
                                                <td class="text-left pb20"
                                                    ...
                                                    <multiline>HRM / Chat Credentials.
                                                        <br><br>
                                                        URL: http://employee.arcinventador.com
                                                        <br><br>
                                                        Useremail: {{$empdata->emp_com_email}}
                                                        <br><br>
                                                        Password: arc@2023
                                                        <br><br>
                                                        Thank you for Joining Cyberxify.
                                                        <br>
                                                        <br>
