...
<body class="body"style="padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; background:#5069e7; -webkit-text-size-adjust:none;">
					...
					<tr>
						<td class="td" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<!-- Logo -->
								<tr>
									<td bgcolor="#ffffff" class="p30-15 img-center" style="padding: 30px; border-radius: 20px 20px 0px 0px; font-size:0pt; line-height:0pt; text-align:left;"><a href="" target="_blank"><img src="{!! asset('public/img/autelecom.png') !!}" width="146" height="57" border="0" alt="" /></a></td>
								</tr>
								<!-- END Logo -->
								<!-- Nav -->
 ...
 <p style="margin: 0; color: #000;">
											...
											<!-- <tr>
												<td class="text-left pb20"style="color:#5d5c5c; font-family:'Raleway', Arial,sans-serif; font-size:14px; line-height:22px; text-align:left; padding-bottom:20px;">
                                                    <multiline>We want to thank you for taking the time to submit your job application to AU TELECOM. We appreciate your interest in our organization and the effort you put into completing the application process.
                                                    <br>
                                                    <br>
