...
<head>
    ...
    <link
        ...
        rel="stylesheet" />
    <!--<![endif]-->
    <title>Offer Letter - AU TELECOM</title>
    <!--[if gte mso 9]>
...
<body class="body"
    ...
    <div class="preheader"
        ...
        We have offer for you - Offer Letter
    </div>
                                ...
                                <tr>
                                    <td bgcolor="#ffffff" class="p30-15 img-center"
                                        ...
                                        <a href="https://www.arcinventador.com/" target="_blank"><img
                                                src="{!! asset('public/img/autelecom.png') !!}" width="146" height="57"
                                                border="0" alt="" /></a></td>
                                </tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="h2-center"
                                                    ...
                                                    <multiline>Dear {{$datas['candidatedata']->jobapplicant_name }}</multiline>
                                                </td>
                                            </tr>
                                            <!-- <tr>
                                            ...
                                            <tr>
                                                <td class="text-left pb20"
                                                    ...
                                                    <multiline>  We are pleased to inform you that based on your qualifications, experience, and interview performance, AU TELECOM has decided to offer you the position of <strong>{{$datas['candidatedata']->evu_cantechdesgdept}}</strong>.
                                                        <br><br>
                                                        <!-- <p>{{$datas['candidatedata']->evu_cansalary}}</p><br><br> -->
                                                        We believe that your skills and experience align with our organization's requirements, and we are confident that you will be a valuable addition to our team. Enclosed, you will find your appointment letter that outlines the terms and conditions of your employment with AU TELECOM.
                                                        <br><br>
                                                        ...
                                                        <br><br>
                                                        To accept the offer, please reply on this email as you have accepted our offer. 
                                                        <br><br>
                                                        ...
                                                        <br><br>
                                                        Congratulations once again, and we wish you all the best for a successful career at AU TELECOM.
                                                        <br><br>
                                ...
                                <tr>
                                    <td class="text-footer2 p30-15"
                                        ...
                                        <multiline style="color: #fff;">3rd floor B&H house, B-75, Gulshan-e-Iqbal,
                                            ...
                                            <p style="color: #fff;">© 2023 AU TELECOM . All Right Reserved.</p>
                                        </multiline>
                                    </td>
                                </tr>
                            </table>
