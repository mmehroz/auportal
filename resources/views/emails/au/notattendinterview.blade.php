...
<body class="body"
    ...
    <div class="preheader"
        ...
        Invitation to Reschedule Interview - AU TELECOM
    </div>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="text-left pb20"
                                                    ...
                                                    <multiline> We hope this email finds you well. We are writing to follow up on the interview that was scheduled for you on <b>{{$datas['candidate']->jobapplicant_intDateandTime }}.</b> for the <b>{{$datas['candidate']->jobapplicant_postionapppliedform }}.</b> position at AU TELECOM. We were disappointed that you were not able to attend the interview, and we hope that everything is okay.
                                                        <br><br>
                                                        ...
                                                        <br><br>
                                                        Thank you for considering AU TELECOM as your potential employer. We appreciate your interest in our organization, and we look forward to hearing back from you soon.
                                                        <br><br>
