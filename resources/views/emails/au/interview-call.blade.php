...
<head>
    ...
    <link
        ...
        rel="stylesheet" />
    <!--<![endif]-->
    <title>Invitation to Interview - AU TELECOM</title>
    <!--[if gte mso 9]>
...
<body class="body"
    ...
    <div class="preheader"
        ...
        Invitation to Interview - AU TELECOM
    </div>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="text-left pb20"
                                                    ...
                                                    <multiline>We are pleased to inform you that your application for the <b>{{$datas['candidatedata']->jobapplicant_postionapppliedform }}.</b> position at AU TELECOM has been reviewed, and we are impressed with your qualifications and experience. As a result, we would like to invite you for an interview with our team.<br><br>
                                                        ...
                                                        <br><br>
                                                        During the interview, you will have the opportunity to meet with members of our hiring team and discuss your skills, experience, and qualifications in further detail. You will also have the opportunity to learn more about AU TELECOM and the role that you have applied for.
                                                        <br><br>
                                                        ...
                                                        <br><br>
                                                        Thank you for considering AU TELECOM as your potential employer, and we look forward to hearing back from you soon.
                                                        <br>
