...
<head>
            ...
            <div class="content container-fluid">
				...
				<form action="" method="POST" class="form-horizontal"enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-md-12">							
								<ul class="nav nav-tabs nav-tabs-bottom">
									...
									<li class="nav-item navtest1 col-md-3">
										<a class="nav-link" data-toggle="tab" href="#COO"><center>Chief Operations Officer</center></a>
									</li>
									<li class="nav-item col-md-3">
										<a class="nav-link navtest" data-toggle="tab" id="hractive" href="#HRM"><center>Human Resource Department</center></a>
									</li>
									@endif
								</ul>
							</div>
					...
					<div class="tab-content">
										...
										<div class="row">
											<div class="col-md-3">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="cooname" value="{{$data['probdata']->probationary_form_empcooname}}" readonly />
												</div>	
											</div>
											<div class="col-md-3">
												<div class="form-group">
													<label class="col-form-label">Chief Operations Officer Date </label>
													<input type="date" class="form-control" name="coodate" value="{{$data['probdata']->probationary_form_empcoodate}}" readonly />
												</div>	
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="col-form-label">Chief Operations Officer Remarks </label>
													<input type="text" class="form-control" name="coocom" value="{{$data['probdata']->probationary_form_empcoocomment}}" readonly />
												</div>	
											</div>
										</div>
									</div>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													...
													<input id="p5" type="text" class="form-control" name="cltm" value="{{$data['probdata']->probationary_form_empconfirmationletter}}" readonly />
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label class="col-form-label">Employee Status</label>
													<input type="text" class="form-control" name="empstatus" value="{{$data['probdata']->probationary_form_empstatus}}" readonly />
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label class="col-form-label">Extension in Probationary Period</label>
													<input type="text" class="form-control" name="extproper" value="{{$data['probdata']->probationary_form_empextentionprobperiod}}" readonly="">
												</div>
											</div>
										</div>
										<div class="row">
											<div id="p5v" class="col-md-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="rifp" value="{{$data['probdata']->probationary_form_empconfirmationlettercomment}}" readonly="">
												</div>	
											</div>
										</div>
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="pawa" value="{{$data['probdata']->probationary_form_emppayrolladvised}}" readonly="">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label class="col-form-label">Senior Manager HR Date  </label>
													<input type="date" class="form-control" name="hrdate" value="{{$data['probdata']->probationary_form_emphrmangerdate}}" readonly="">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label class="col-form-label">Date</label>
													<input type="date" class="form-control" name="hrpartdate" value="{{$data['probdata']->probationary_form_empdate1}}" readonly="">
												</div>
											</div>
										</div>
									</div>
						...
						@endif
						<!-- HR Tab End -->
						<div id="btnsubmit" class="text-center" style="display: none;">
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
				...
				// $('#hractive').on('change.states', function() {
				// 	$("#btnsubmit").toggle($(this).class() == 'active');
				// }).trigger('change.states');
