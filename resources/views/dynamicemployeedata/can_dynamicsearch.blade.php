							...
							<div class="profile-widget">
								...
								<!-- <div class="dropdown profile-action">
									...
									<div class="dropdown-menu dropdown-menu-right"style="position: absolute;will-change: transform;top: 0px;left: 0px;transform: translate3d(-98%, -10%, 0px);">
										...
										<p>Expected Salary: {{$val->jobapplicant_monthlyexpectedsalary}}</p>
										<p>Comfortable in Night?: {{$val->jobapplicant_nightshift}}</p>
									</div>
								</div> -->
                                ...
                                <div class="row" style="display: flex!important; margin-top: 4%;">
									...
									<a href="#" target="_blank" title="Click To View PDF" class="btn btn-sm btn-primary" onclick="getimageview({{'"'.$val->jobapplicant_id.'"'}})" ><i class="fa fa-eye"></i> PDF</a>
                                	</div>
								</div>
							</div>
						</div>
